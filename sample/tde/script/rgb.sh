...
format="--format-s 3 --format-bg 1 --format-out 1"                              #源图 背景图 屏幕格式
file="--file-s $pic_src --file-bg $pic_bg"                                      #文件名称
rect_bg="--rect-bg 1024,600,0,0,1024,600"                                       #背景图坐标

rect_s="--rect-s 160,577,0,0,160,577"                                           #源图坐标
rect_t="--rect-t 432,12,160,577"                                                #贴图到屏幕坐标,屏幕宽高由sample获取
rect_t_rotate="--rect-t 224,220,577,160"                                        #旋转贴图到屏幕坐标
rect_t_scale="--rect-t 362,0,300,600"                                           #拉伸贴图到屏幕坐标

#rect_s="--rect-s 160,577,0,0,80,300"                                           #源图坐标
#rect_t="--rect-t 432,12,80,300"                                                #贴图到屏幕坐标,屏幕宽高由sample获取
#rect_t_rotate="--rect-t 224,220,300,80"                                        #旋转贴图到屏幕坐标
#rect_t_scale="--rect-t 362,0,160,600"                                          #拉伸贴图到屏幕坐标
